...
;${FileRecode} "$EXEDIR\ஒருங்குறிஉதாரணம்.ini" "ToUTF16LE"
;Convert file from UTF-8 to UTF16LE

; Write ஒருங்குறிஉதாரணம்.ini:
FileOpen $0 "$EXEDIR\ஒருங்குறிஉதாரணம்.ini" a ; operate on the converted file. 
...
;${FileRecode} "$EXEDIR\ஒருங்குறிஉதாரணம்.ini" "ToUTF8"
