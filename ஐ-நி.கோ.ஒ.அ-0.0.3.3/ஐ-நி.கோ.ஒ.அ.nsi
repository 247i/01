...
Function ஆம்வடிவமை ; If Format is checked, do something
  ...
  InitPluginsDir
  File /oname=$PLUGINSDIR\diskpartwipe1.txt "..\பொது-இருமங்கள்\நி\diskpartwipe1.txt"  
  File /oname=$PLUGINSDIR\diskpartwipe2.txt "..\பொது-இருமங்கள்\நி\diskpartwipe2.txt" 
  File /oname=$PLUGINSDIR\unassign.txt "..\பொது-இருமங்கள்\நி\unassign.txt"     
...
!include "நிரல்கள்\விநியோகநிறுவல்நீக்கம்.நிரல்" ; ## ADD NEW DISTRO ##
...
StrCpy $R9 0 ; உரிமை உரை தவிர், பக்கம் 0க்கு செல்
 ...
 InitPluginsDir   
  ...
  ;File /oname=$PLUGINSDIR\7za.exe "..\பொது-இருமங்கள்\நி\7za.exe"
  ;File /oname=$PLUGINSDIR\7za.dll "..\பொது-இருமங்கள்\நி\7za.dll"   
  ;File /oname=$PLUGINSDIR\7zxa.dll "..\பொது-இருமங்கள்\நி\7zxa.dll"  
