...
; Windows 10
 ...
 ExecWait '"$PLUGINSDIR\7zG.exe" x "$ISOFile" -xr!install.wim -xr!bootx64.efi -o"$BootDir\" -y' 
 ...
 NsExec::ExecToLog "cmd /C Dism /Split-Image /ImageFile:$EXEDIR\TEMPYUMI\sources\install.wim /SWMFile:$BootDir\sources\install.swm /FileSize:3800"
...
; System Rescue CD
 ${ElseIf} $DistroName == "System Rescue CD" 
  ...
  !insertmacro ReplaceInFile "archisolabel=RESC" "archisolabel=MULTIBOOT NULL=" "all" "all" "$BootDir\multiboot\$JustISOName\$GrubCopyPath\$GrubConfigFile"   
